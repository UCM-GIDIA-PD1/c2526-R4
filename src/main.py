...
from src.utils.main_config import main_transformacion_info, main_extraccion_info, main_modelos_info, main_pipeline_info
...
def ejecutar_scripts(scripts_info, minio_info, page):
    ...
    elif page == 4: sys.path.append(os.path.join(BASE_DIR, "E_pipeline"))
...
def main():
    ...
    scripts_info = [main_extraccion_info, main_transformacion_info, main_modelos_info, main_pipeline_info]
    page = 0 # 0 --> generico | 1 --> extracción | 2 --> transformacion | 3 --> modelos | 4 --> pipeline
