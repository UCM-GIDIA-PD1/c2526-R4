...
from src.A_Extraccion.utils_extraccion.sesion import handle_input, ask_overwrite_file, read_config, update_config
    
def _get_request_params():
    """
    Obtiene los parámetros del usuario para la extracción de appids

    Args:
        None
    
    Returns:
        (int, str): (Número de appids a extraer, appid desde el que hay que extraer)
    """
