...
precios_knncompleteclusters_pca_file = models_precios_path() / "knncompleteclusters_pca.pkl"
precios_knnreduced_file = models_precios_path() / "knnreduced.pkl"
precios_knnreduced_oversampled_file = models_precios_path() / "knnreduced_oversampled.pkl"
